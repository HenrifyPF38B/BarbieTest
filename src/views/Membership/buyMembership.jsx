      ...
      <div className={style.div} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={`${style.paypalContainer} ${isMenuOpen ? style.open : ""}`}>
          <PayPalButtons
                ...
                dispatch(makeMember({
                  userId: usersId.id,
                  expire: membershipModal.duration === "Three months" ? date.setDate(date.getDate() + 90) : membershipModal.duration === "Six months" ? date.setDate(date.getDate() + 180) : date.setDate(date.getDate() + 365)
                }))
                navigate("/success");
                }}
